...
const Index = () => {
  ...
  const translations = {
    en: {
      heroTitle: 'Boost your stock trading training strategy with AI powered indicators',
    ...
    hi: {
      heroTitle: 'एआई संकेतकों के साथ अपनी स्टॉक ट्रेडिंग ट्रेनिंग रणनीति को बढ़ावा दें',
    ...
    ur: {
      heroTitle: 'اے آئی اشاریہ کے ساتھ اپنی اسٹاک ٹریڈنگ ٹریننگ حکمت عملی کو فروغ دیں',
      ...
      aboutText1: 'SGSCRIPT ایسے ٹیک پروڈکٹس بناتا ہے جو اہمیت رکھتے ہیں۔ ہم پریمیم ٹریڈنگ ٹولز بنانے پر توجہ مرکوز کرتے ہیں جو آپ کو اپنے مالی اہداف کو درستگی اور اعتماد کے ساتھ حاصل کرنے میں مدد کرتे ہیں۔',
      aboutText2: 'ہمارا فلیگشپ پروڈکٹ، SGSCRIPT، اعلی درجے کے ٹریڈنگ انڈیकیٹرز فراہم کرتا ہے جو آپ کے مارکیٹوں کے تجزیے اور ٹریڈنگ کے فیصلوں کو تبدیل کردیں گے۔',
      ...
      feature3Desc: 'SGSCRIPT درست سگنلز اور بصیرتیں فراہم کرتا ہے جو آپ کو مسلسل آگاہی سے بھرپور ٹریڈنگ فیصلے کرنے میں मدد کرتे ہیں۔',
      whatWeveDone: 'ہم نے کیا کیا ہے',
      hearFromClients: 'ہمارे کلائنٹس सے سنیں',
      readyToWork: 'ہمارे सاٹھ کام كرنے کے لیے تیار ہیں?',
    ...
    ar: {
      heroTitle: 'عزز استراتيجية التداول والتدريب على الأسهم الخاصة بك بمؤشرات مدعومة بالذكاء الاصطناعي',
